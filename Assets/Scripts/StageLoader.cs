...
public class StageLoader : MonoBehaviour
{
    ...
    public bool Loaded;
    [Header("Breakable")]
    public int BreakableChangeLevels;
    [Header("Lego")]
    public int LegoChangeLevels;
    [Header("Chocolate")]
    public int ChocolateChangeLevels;
    [Header("Bubbles")]
    public int BubblesChangeLevels;
    ...
    public int FriendBlockColorNumber;
    [Header("Stars")]
    ...
    public ITEM_TYPE RandomItems()
    {
        ...
        int index = 0;
        //thiscomment
        index = SkillzCrossPlatform.Random.Range(0, items.Count);
        //skillzrandomcookie
        //change number
        //if (PlayerPrefs.GetInt("SkillzLevel") == 0)
        //{
        //    index = UnityEngine.Random.Range(0, Configuration.instance.Level1.Count);
        //}
        //else if (PlayerPrefs.GetInt("SkillzLevel") == 1)
        //{
        //    index = UnityEngine.Random.Range(0, Configuration.instance.Level2.Count);
        //}
        //else if (PlayerPrefs.GetInt("SkillzLevel") == 2)
        //{
        //    index = UnityEngine.Random.Range(0, Configuration.instance.Level3.Count);
        //}
        return items[index];
    }
