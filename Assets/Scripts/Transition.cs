...
public class Transition : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //m_canvas = GameObject.Find("Transition");
    ...
    public static void LoadLevel(string level, float duration, Color color)
    {
        ...
        //var fade = GameObject.Find("Transition");
        m_canvas.GetComponent<Transition>().StartFade(level, duration, color);
        
        //fade.transform.SetParent(m_canvas.transform, false);
        m_canvas.transform.SetAsLastSibling();
        System.GC.Collect();
    }
    ...
    private IEnumerator RunFade(string level, float duration, Color fadeColor)
    {
        ...
        // add loading image
        var loadingImage = Instantiate(Resources.Load(Configuration.LoadingImage())) as GameObject;
        ...
        //var time = 0.0f;
        //var halfDuration = duration / 5.0f;
